...
export default function InterviewPdfDownloadButton({ subjectName }) {
  ...
  // Go Back function
  const goBack = () => {
    window.history.back(); // browser history ke previous page par le jaayega
  };
